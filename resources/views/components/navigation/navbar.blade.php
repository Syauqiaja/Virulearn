...
<div id="sidebarMenu" class="col-md-3 col-lg-2 d-block d-flex flex-column bg-white sidebar position-fixed h-100 p-3">
  <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
    ...
    <span class="fs-4">Virulearn</span>
  </a>
  <hr>
  ...
  <div class="dropdown ">
    ...
    <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser2">
      ...
      {{-- <li><a class="dropdown-item" onclick="Livewire.dispatch('openLogoutConfirmation', { component: 'modals.logout-confirmation-modal' })">Sign out</a></li> --}}
    </ul>
  </div>
