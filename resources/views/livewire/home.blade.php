<div>
    ...
    <div class="bg-primary rounded p-3 text-white position-relative overflow-hidden">
        ...
        <img class="d-md-block d-sm-none" src="{{ asset('assets/images/learning.png') }}" alt=""
        ...
        <div class="position-relative" style="z-index: 1;">
            ...
            <p>
                Selamat datang di Virulearn. Pelajari segala hal <br>tentang virus di sini
            </p>
    ...
    <div class="row mx-0 mt-3 gap-2">
        <div class="col-md-6 col-sm-12 bg-white rounded p-3">
            ...
            <a class="btn btn-info text-white" href="{{ route('exam.detail', ['type' => 'pretest']) }}">Mulai Pretest</a>
        </div>
        <div class="col-md col-sm-12 {{ $completedActivity == 1 ? 'bg-white' : 'bg-light' }} bg-white rounded p-3">
            ...
            <a class="btn btn-info text-white {{ $completedActivity == 1 ? '' : 'disabled' }}" href="{{ route('exam.detail', ['type' => 'posttest']) }}">Mulai Posttest</a>
        </div>
    </div>
    <div class="row mt-3 gap-2 mx-0">
